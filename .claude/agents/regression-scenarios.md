...
tools: Read, Bash, Grep, Glob, Write, Skill, mcp__claude_ai_Context7__resolve-library-id, mcp__claude_ai_Context7__query-docs
---
...
Load the playwright-cli skill (Skill tool), then:
