...
tools: ['search/codebase', 'search', 'execute/runInTerminal', 'execute/getTerminalOutput', 'web/fetch']
---
...
the AUT itself is currently up before blaming the tests: use the playwright-cli
skill (`.github/skills/playwright-cli/`) and drive the app (`playwright-cli open <BASE_URL>`,
